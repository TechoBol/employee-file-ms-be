...
import com.efms.employee_file_ms_be.command.absence.AbsenceDeleteCmd;
...
public class AbsenceDeleteController {

    private final AbsenceDeleteCmd command;

    @DeleteMapping("/{id}")
    @Operation(summary = "Delete an Absence by id")
