...
import com.efms.employee_file_ms_be.command.position.PositionListCmd;
...
public class PositionListController {
    ...
    private final PositionListCmd command;

    @GetMapping
    @Operation(summary = "Get positions by company ID")
    public ResponseEntity<List<PositionResponse>> getByCompany() {
        command.execute();
