...
import com.efms.employee_file_ms_be.command.advance.AdvanceDeleteCmd;
...
public class AdvanceDeleteController {

    private final AdvanceDeleteCmd command;

    @DeleteMapping("/{id}")
    @Operation(summary = "Delete an Advance by id")
