...
import com.efms.employee_file_ms_be.command.advance.AdvancePatchCmd;
...
public class AdvancePatchController {

    private final AdvancePatchCmd command;

    @PatchMapping("/{id}")
    @Operation(summary = "Update an Advance associated an user")
    public ResponseEntity<AdvanceResponse> patchAdvance(@PathVariable String id,
