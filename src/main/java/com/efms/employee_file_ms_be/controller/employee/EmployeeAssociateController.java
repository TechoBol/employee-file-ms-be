...
import com.efms.employee_file_ms_be.command.employee.EmployeeAssociateCmd;
...
public class EmployeeAssociateController {

    private final EmployeeAssociateCmd command;
