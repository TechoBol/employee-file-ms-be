...
public class MemorandumListByEmployeeIdCmd implements Command {
    ...
    public void execute() {
        ...
        memorandumList = repository.findByEmployeeAndCompanyInDateRange(UUID.fromString(employeeId), companyId, startDate, endDate);
