...
public class PositionListByDepartmentIdCmd implements Command {
    ...
    public void execute() {
        ...
        List<Position> positionsByCompany = repository.findAllByCompanyIdAndDepartmentId(companyId, UUID.fromString(departmentId));
