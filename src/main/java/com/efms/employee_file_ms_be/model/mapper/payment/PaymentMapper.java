...
public class PaymentMapper {
    ...
    public PaymentDetailsResponse toDTO(Payment payment) {
        ...
        return PaymentDetailsResponse.builder()
                ...
                .grossAmount(paymentDetails.getGrossAmount())
                .deductionAfpPercentage(paymentDetails.getDeductionAfpPercentage())
                .deductionAfp(paymentDetails.getDeductionAfp())
                .deductions(paymentDetails.getDeductions().stream().map(this::mapDeduction).toList())
                .totalDeduction(paymentDetails.getTotalDeductions())
